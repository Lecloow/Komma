...
@Observable class ProjectViewModel {
    private var model = createProjectModel()
    var confettiSubtasksCounter = 0
    ...
    //TODO: If a task or a project or a subtask is empty delete it on appear of the HomeView (to be sure it's not deleting something that was just created)
